...
<main class="">
  ...
  {#each Array(6) as _, i}
		<li class="card  bg-transparent top-20" id="card_1">
			<div class="card__content bg-violet-600 py-2 rounded-md">
				<div>
					<h2>Card One</h2>
					<p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
					<p><a href="#top" class="btn btn--accent p-1 rounded-md bg-violet-100">Read more</a></p>
				</div>
				<figure>
					<img class="rounded-sm" src="blogImages/kindle-fire-7.jpg" alt="Image description">
				</figure>
			</div>
		</li>
  {/each}
