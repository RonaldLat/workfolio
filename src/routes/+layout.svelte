...
<div class="min-h-screen font-[Poppins] overflow-visible bg-myColor-50">
  ...
  <nav
    class="fixed z-30 top-3.5 left-0 px-3 py-0.5 bg-transparent text-gray-50 h-13  border-gray-400  font-extrabold flex flex-row items-center w-full justify-between transition ease-in"
