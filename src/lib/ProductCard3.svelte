<script>
	export let image, name, id, category, price, old_price;
    ...
    <div>
      ...
      <div class="px-4 py-3 w-72">
        ...
        <div class="flex items-center">
          <p class="text-lg font-semibold text-black cursor-auto my-3">Ksh.{price}</p>
          <del>
          {#if old_price }
            <p class="text-sm text-gray-600 cursor-auto ml-2">Ksh.{old_price}</p>
          {/if}
          </del>
          <div class="ml-auto">
          <a href="https://wa.me/+254723717089" target="_blank" class="flex justify-center items-center gap-0.5 bg-myColor-100 rounded-lg p-0.5 border border-myColor-300">
