...
<div class="grid grid-cols-2 justify-items-start w-full items-center px-2 bg-black py-1 max-w-5xl mx-auto">
	<a href="/" class="h-full flex flex-row items-center text-myColor-600">
  <p class="text-3xl text-center font-bold">J</p>
		<svg class="inline-block h-16 py-2 fill-sky-100 text-sky-100 hidden" width="" viewBox="0 0 200 200"
			...
			/></svg
		>
		<span class="font-blackops text-gray-100 h-full flex flex-col justify-center pl-1">
			<p class="whitespace-nowrap text-xs ">eep</p>
			<p class="text-xs">Auto Spares</p>
		</span>
	</a>
