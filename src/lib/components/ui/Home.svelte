  <div class="relative flex flex-col-reverse w-full py-16 lg:pt-0 lg:flex-col lg:pb-0">
    ...
    >
      <svg
        class="absolute left-0 hidden h-full text-gray-400 transform -translate-x-1/2 lg:block"
        viewBox="0 0 100 100"
        fill="currentColor"
      ...
      <img
        class="object-cover w-full bg-gray-400 rounded shadow-sm h-96 lg:rounded-none lg:shadow-none md:h-auto lg:h-full"
    ...
    >
      ...
      <div class="flex-row space-y-2 pr-5 mb-5 text-base text-gray-700 md:text-lg ">
        <p>
        Hello! I'm Ronald Otieno, a software developer specializing in web development, data visualization, and machine learning.
        </p>
        <p>
With expertise in dynamic web applications and a focus on D3.js for captivating visualizations, I'm excited to collaborate on impactful projects. Let's make a difference together!
        </p>
      </div>
