...
>
	...
	<button class="px-2 py-3 bg-emerald-300 rounded-md border-gray-700 mt-3 border" on:click={sort}
		>Quick Sort</button
	>
	<button
		class="px-2 py-3 bg-pink-300 rounded-md border-gray-700 mt-3 border"
		on:click={() => (numbers = getRandomIntArray(9, 1, 99))}>Generate Array</button
	>
</div>
