...
<footer class="w-full mx-auto   shadow    {className} rounded-tl-md rounded-tr-md">
    ...
    <p class="text-gray-800 bg-black mx-auto w-fit my-6 border border-b-myColor-1000 border-r-0 border-l-0 border-t-0  px-4 py-6 rounded-md flex items-center justify-center">
