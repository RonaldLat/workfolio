...
const Counter = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let count = 1;
  return `<div class="p-2 text-sky-400 bg-sky-100 hover:bg-sky-300">${escape(
    count
  )}</div>`;
});
const metadata = {
