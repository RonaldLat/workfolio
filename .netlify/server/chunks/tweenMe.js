	...
	distribute = function distribute2(v) {
		...
		return function (i, target, a) {
			...
			if (!distances) {
				...
				originY =
					wrapAt === _bigNum$1 ? 0 : ratios ? (l * ratioY) / wrapAt - 0.5 : (from / wrapAt) | 0;
				max = 0;
				min = _bigNum$1;
				for (j = 0; j < l; j++) {
					x = (j % wrapAt) - originX;
...
var Tween = /* @__PURE__ */ (function (_Animation2) {
	...
	function Tween2(targets, vars, position, skipInherit) {
		...
		var _this3$vars = _this3.vars,
			...
			parsedTargets = (
				_isArray(targets) || _isTypedArray(targets) ? _isNumber$1(targets[0]) : 'length' in vars
			)
				? [targets]
				: toArray(targets),
			tl,
...
var _gsap = {
	...
	quickTo: function quickTo(target, property, vars) {
		...
		var tween = gsap$2.to(
				target,
				_merge(
					((_merge22 = {}), (_merge22[property] = '+=0.1'), (_merge22.paused = true), _merge22),
					vars || {}
				)
			),
	...
	registerEffect: function registerEffect(_ref3) {
		...
		if (extendTimeline) {
			Timeline.prototype[name] = function (targets, vars, position) {
				return this.add(
					_effects[name](targets, _isObject$1(vars) ? vars : (position = vars) && {}, this),
					position
				);
			};
		}
...
var _win$2,
  ...
  */
	...
	_addPxTranslate = function _addPxTranslate2(target, start, value) {
		...
		return (
			_round$1(parseFloat(start) + parseFloat(_convertToUnit(target, 'x', value + 'px', unit))) +
			unit
		);
	},
	...
	_proto.init = function init4(vars) {
		...
		var id,
			...
			_onWheel = function _onWheel2(e) {
				...
				var multiplier =
					(e.deltaMode === 1 ? lineHeight : e.deltaMode === 2 ? _win$1.innerHeight : 1) *
					wheelSpeed;
...
var gsap,
	...
	_parseClamp = function _parseClamp2(value, type, self) {
		var clamp3 =
			_isString2(value) && (value.substr(0, 6) === 'clamp(' || value.indexOf('max') > -1);
...
var ScrollTrigger = /* @__PURE__ */ (function () {
	...
	ScrollTrigger2.config = function config3(vars) {
		...
		'ignoreMobileResize' in vars &&
			(_ignoreMobileResize = ScrollTrigger2.isTouch === 1 && vars.ignoreMobileResize);
