...
const Sidebar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	}"><aside class="w-full h-full border-r-2 text-gray-100"><nav class="p-12 text-xl"><a class="${[
		'block',
		(route = '/') ? 'text-white' : ''
	]
		.join(' ')
...
const TheFooter = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	return `<footer class="flex flex-col w-full px-4 py-16 text-gray-200 bg-black md:px-24 lg:px-8 lg:py-20 gap-2"><p class="text-sm font-bold tracking-wide text-gray-200 uppercase" data-svelte-h="svelte-102dcmh">subscribe</p> <p class="text-gray-400" data-svelte-h="svelte-b5swgf">Subscribe to my newsletter to get regular content I publish on my blog.</p> <div class="max-w-md pt-3"></div> <ul class="flex font-[Play] capitalize gap-3 text-myColor-300" data-svelte-h="svelte-48tp2f"><li><a href="/">Home</a></li> <li><a href="portofolio">Portofolio</a></li> <li><a href="/blog">Blog</a></li></ul> <p class="text-sm text-gray-500">© ${escape(
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div class="${[
		...
		{},
		{}
	)} <a href="https://github.com/RonaldLat" class="">${validate_component(
		Github$1,
		'Github'
	).$$render(
		$$result,
		...
		{},
		{}
	)}</a> <a href="/blog" class="flex items-center">${validate_component(
		Newspaper$1,
		'Newspaper'
	).$$render(
		$$result,
		...
		{},
		{}
	)}<span class="text-xs" data-svelte-h="svelte-6wcriq">Blog</span></a></nav> ${validate_component(
		TheFooter,
		'TheFooter'
	).$$render($$result, {}, {}, {})}`;
});
