...
const Mail = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Icon, 'Icon').$$render(
    $$result,
    Object.assign({}, { name: 'mail' }, $$props, { iconNode }),
    {},
    {
      default: () => {
        return `${slots.default ? slots.default({}) : ``}`;
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="min-h-screen font-[Poppins] overflow-hidden bg-myColor-50"><div class="${[
    ...
    .join(' ')
    .trim()}"><div class="flex w-full gap-3"><button class="hover:text-myColor-700 transition duration-100 delay-75">${validate_component(
    Menu$1,
    'Menu'
  ).$$render(
    $$result,
    ...
    {},
    {}
  )}</button> <a href="/blog" class="flex items-center hover:text-myColor-700 transition duration-100 delay-75" data-svelte-h="svelte-1qk8of1"><span class="text-sm hover:text-myColor-700 hover:scale-90 transition duration-100 delay-75 ease-in">Blog</span></a></div> <div class="flex gap-3">${validate_component(
    Linkedin$1,
    'Linkedin'
  ).$$render($$result, { class: '' }, {}, {})} ${validate_component(
    Mail$1,
    'Mail'
  ).$$render(
    $$result,
    ...
    Github$1,
    'Github'
  ).$$render($$result, {}, {}, {})}</a></div></nav> ${validate_component(
    TheFooter,
    'TheFooter'
  ).$$render($$result, {}, {}, {})}</div>`;
});
