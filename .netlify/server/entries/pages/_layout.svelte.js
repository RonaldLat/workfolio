...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  ].join(" ").trim()}"> <button class="p-2 text-3xl text-white fixed bottom-1 right-1 ">${validate_component(ChevronFirst, "ChevronFirst").$$render($$result, {}, {}, {})}</button>  ${validate_component(Sidebar, "Sidebar").$$render($$result, {}, {}, {})} </div> <main class="mb-36 mx-auto w-full min-h-screen font-[Poppins]">${slots.default ? slots.default({}) : ``}</main> <nav class="${[
  ...
  ].join(" ").trim()}"><button class="">${validate_component(Menu$1, "Menu").$$render($$result, {}, {}, {})}</button> ${validate_component(Linkedin$1, "Linkedin").$$render($$result, {}, {}, {})} ${validate_component(Github$1, "Github").$$render($$result, {}, {}, {})} <a href="/blog" class="">${validate_component(Newspaper$1, "Newspaper").$$render($$result, {}, {}, {})}Blog</a></nav> ${validate_component(TheFooter, "TheFooter").$$render($$result, {}, {}, {})}`;
});
export {
  Layout as default
};
