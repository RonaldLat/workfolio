...
const BinarySearch = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let parent = true;
    let children = [1, 2];
    $$result.css.add(css$1);
    return `<div class="controls svelte-16ohf36"><label><input type="checkbox"${add_attribute(
      'checked',
      parent,
      1
    )}>
    Parent</label></div> ${`<div class="parent svelte-16ohf36"><span class="svelte-16ohf36" data-svelte-h="svelte-jtgwhe">Parent</span> ${each(
      children,
      (child) => {
...
const Dijkstras = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let notifications = 0;
    $$result.css.add(css);
    return `<div class="notifications svelte-1r0agn5"><div class="count svelte-1r0agn5"><span>${escape(
      notifications
    )}</span></div> <svg class="bell svelte-1r0agn5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-width="1.5" stroke="currentColor"><path d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75v-.7V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0" stroke-linecap="round" stroke-linejoin="round"></path></svg> </div>`;
  }
);
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<h2 data-svelte-h="svelte-1vdxp5p">Data Structures and Algorithms</h2> ${validate_component(
